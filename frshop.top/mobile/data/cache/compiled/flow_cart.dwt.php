...
?>
      <li>
        <div class="ect-clear-over"> <a href="<?php echo url('goods/index',array('id'=>$this->_var['goods']['goods_id']));?>"><img src="<?php echo $this->_var['goods']['goods_img']; ?>" title="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>"></a>
          <dl>
            <dt>
