...
<link href="themes/mazentop/style.css" rel="stylesheet" type="text/css" />
...
?>
    ...
    <form id="formCart" name="formCart" method="post" action="flow.php">
       <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1">
        <tr>
          <th height="60"><?php echo $this->_var['lang']['goods_name']; ?></th>
...
?>
        <tr>
          <td align="center" style="width:300px;" class="tpline">
...
?>
          ...
          <?php if ($this->_var['show_goods_attribute'] == 1): ?>
          <td class="tpline"><?php echo nl2br($this->_var['goods']['goods_attr']); ?></td>
          <?php endif; ?>
          <?php if ($this->_var['show_marketprice']): ?>
          <td align="center" class="tpline"><?php echo $this->_var['goods']['market_price']; ?></td>
          <?php endif; ?>
          <td align="center" class="tpline"><?php echo $this->_var['goods']['goods_price']; ?></td>
          <td align="center" class="tpline">
            <?php if ($this->_var['goods']['goods_id'] > 0 && $this->_var['goods']['is_gift'] == 0 && $this->_var['goods']['parent_id'] == 0): ?>
            <span class="goods_cut" onclick="goods_cut('<?php echo $this->_var['goods']['rec_id']; ?>');"><img src="themes/mazentop/images/jian.gif" align="absmiddle" /></span> 
            ...
            <span class="goods_add" onclick="goods_add('<?php echo $this->_var['goods']['rec_id']; ?>');"><img src="themes/mazentop/images/jia.gif" align="absmiddle" /></span>
            <?php else: ?>
            <?php echo $this->_var['goods']['goods_number']; ?>
            <?php endif; ?>
          </td>
          <td align="center" class="tpline"><?php echo $this->_var['goods']['subtotal']; ?></td>
          <td align="center" class="tpline">
        ...
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
      </table><input name="submit" type="submit" style="display:none"  id="updatecart" value="<?php echo $this->_var['lang']['update_cart']; ?>" />
    ...
    <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="margin-top:20px;">
      <tr>
        <td height="50" width="90" align="right"><a href="./">继续购物</a></td>
        <td align="right"><font class="f6"><?php echo $this->_var['shopping_money']; ?></font><a href="flow.php?step=checkout" class="flowbtn">去结算</a></td>
      </tr>
    </table>
    <div class="blank"></div>
...
?>
        <ul class="clearfix">
            ...
            <a href="javascript:fittings_to_flow(<?php echo $this->_var['fittings']['goods_id']; ?>,<?php echo $this->_var['fittings']['parent_id']; ?>)"><img src="themes/mazentop/images/bnt_buy.gif" alt="<?php echo $this->_var['lang']['collect_to_flow']; ?>" /></a>
            </li>
        </ul>
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
      </div>
...
?><br />
        ...
        <tr>
          <td align="right">&nbsp;</td>
          <td align="center"><input type="image" src="themes/mazentop/images/bnt_cat.gif" alt="Add to cart"  border="0" /></td>
        </tr>
        <?php endif; ?>
      </table>
...
?>
    ...
    <div class="flowBox">
      ...
      <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1">
        ...
        <?php endif; ?>
        <tr>
          <td><?php echo $this->_var['lang']['backup_phone']; ?>/<?php echo $this->_var['lang']['phone']; ?>:</td>
...
?>
    ...
    <div class="flowBox">
      ...
      <div align="center" style="margin:8px auto;">
        <input type="submit" class="us_Submit_reg2" value="提交订单" />
  ...
  <?php if ($this->_var['step'] == "done"): ?>
    ...
    <div class="flowBox" style="margin:0 auto 70px auto;">
      ...
      <table width="99%" align="center" border="0" cellpadding="15" cellspacing="0" bgcolor="#fff" style="border:1px solid #ddd; margin:20px auto;" >
        ...
        <tr>
          <td align="center" bgcolor="#FFFFFF"><?php echo $this->_var['order']['pay_desc']; ?><br/>支付宝扫码支付：<img src="http://www.frshop.top/themes/mazentop/images/pay.jpg" width="150" align="absmiddle" /></td>
        </tr>
      ...
      <tr>
        ...
        <table width="90%" border="0" cellpadding="8" cellspacing="0" class="table">
         ...
         <?php if ($this->_var['enabled_login_captcha']): ?>
          ...
          <?php endif; ?>
          <tr>
            <td colspan="2" style="padding-left:80px;"><input type="checkbox" value="1" name="remember" id="remember" /><label for="remember"><?php echo $this->_var['lang']['remember']; ?></label></td>
          </tr>
          <tr>
