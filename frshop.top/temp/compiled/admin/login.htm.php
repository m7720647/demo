...
<form method="post" action="privilege.php" name='theForm' onsubmit="return validate()">
  ...
  <tr>
    ...
    <td style="padding-left: 50px">
      ...
      <?php endif; ?>
      <tr style="display:none;"><td colspan="2"><input type="checkbox" value="1" name="remember" id="remember" checked="checked" /><label for="remember"><?php echo $this->_var['lang']['remember']; ?></label></td></tr>
