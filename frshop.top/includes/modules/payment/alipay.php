...
class alipay
{
    ...
    function get_code($order, $payment)
    {
        ...
        $button = '<div style="text-align:center">点击去支付宝付款：<a href="https://mapi.alipay.com/gateway.do?'.$param. '&sign='.md5($sign).'&sign_type=MD5" target="_blank"><img src="themes/mazentop/images/logo-zfb.png" alt="' .$GLOBALS['_LANG']['pay_button']. '" /></a></div>';
